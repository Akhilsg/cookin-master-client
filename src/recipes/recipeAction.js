...
export const exploreRecipes = () => {
  return (dispatch) => {
    return axios
      .get("http://localhost:5000/api/recipes/allRecipes")
      .then((res) => {
...
export const getAllRecipes = (token) => {
  return (dispatch) => {
    ...
    axios
      .get("http://localhost:5000/api/users/recipes", config)
      .then((res) => {
...
export const createRecipe = (token, data, history) => {
  return (dispatch) => {
    ...
    axios
      .post("http://localhost:5000/api/recipes/", draftRecipe, config)
      .then((res) => {
...
export const getCurrentRecipe = (recipeId, token, history) => {
  return (dispatch) => {
    ...
    axios
      .get(`http://localhost:5000/api/recipes/${recipeId}`, config)
      .then((res) => {
        let recipe = res.data.recipe;
        recipe.creator = res.data.user;
        dispatch({
...
export const deleteRecipe = (recipeId, token, history) => {
  return (dispatch) => {
    ...
    axios
      .delete(`http://localhost:5000/api/recipes/${recipeId}`, config)
      .then((res) => {
...
export const uploadImage = (file, token) => {
  return (dispatch) => {
    ...
    return axios
      .post(`http://localhost:5000/api/recipes/upload`, data, config)
      .then((res) => {
...
export const unlikeRecipe = (recipeId, token) => {
  return (dispatch) => {
    ...
    axios
      .put(
        `http://localhost:5000/api/recipes/${recipeId}/unlike`,
        null,
        config
      )
      .then((res) => {
